...
import com.hhr.accountbook.model.ExcelBean;
...
public class ExcelUtil {
     ...
     *            标题列行数以及cell字体样式
     */
    public XSSFWorkbook createExcelFile(Class clazz, List objs, Map<Integer, List<ExcelBean>> map,
     ...
     *            每行每个单元格对应的列头信息
     */
    public void createTableHeader(XSSFSheet sheet, Map<Integer, List<ExcelBean>> map) {
    ...
    public void createTableRows(XSSFSheet sheet, Map<Integer, List<ExcelBean>> map, List objs, Class clazz)
