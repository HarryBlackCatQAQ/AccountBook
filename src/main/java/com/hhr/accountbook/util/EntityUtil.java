...
public class EntityUtil {
     ...
     * @return 实体类集合
     */
    public <T> List<T> castEntity(List<Object[]> list, Class<T> clazz, Object model) {
     ...
     * @return 属性值
     */
    private Object getFieldValueByName(String fieldName, Object modle) {
        try {
     ...
     * @return list集合
     */
    private List<Map> getFiledsInfo(Object model) {
